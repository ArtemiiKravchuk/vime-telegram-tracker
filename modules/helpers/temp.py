...
def save_results(module: str, id: str, data) -> None:
    ...
    logger.debug("Saving record for user <y>{}</> in temp", id)
    with open(path[1], "w") as file:
        json.dump(data, file)


def append_results(module: str, id: str, data: list) -> None:
    ...
    if prev_results is None:
        ...
        new_results = prev_results.append(data)
        save_results(module, id, new_results)
